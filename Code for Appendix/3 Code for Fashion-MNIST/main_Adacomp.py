...
def main():
    ...
    for epoch in range(1, int(0.5*args.epochs) + 1):
        lr, losses_neib, lr_list = train(args, model, device, optimizer, train_loader, epoch,
    ...
    with open('./results_1022.txt', 'a+') as fl:
        fl.write('FashionMNIST, Optimizer is AdaCompen, Seed is {}, LR is {}, batch size is {} \n '                 
                 ' test acc is{} \n test pre is {} \n test reca is {} \n test f1 is {}\n time is {} \n\n'.
    ...
    print("Costing time is ", end-begin)
